...
AGENT_SYSTEM_PROMPT = (
    ...
    "2. If the user asks ANY legal question (even if you think you know the answer), you MUST ALWAYS call a tool to retrieve the exact statutory language. NEVER answer a legal question from your pre-trained memory.\n"
    "   - Use `search_indian_law` for criminal law, IPC, BNS, CRPC, or Tax law.\n"
    "   - Use `search_web` for any other legal queries (e.g. Constitutional law, SEBI, Family law, marriage age).\n"
